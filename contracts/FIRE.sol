...
interface IDexpertSwapV1Factory {
    function createPair(address tokenA, address tokenB) external returns (address pair);
    function getPair(address tokenA, address tokenB) external view returns (address pair);
}

interface IDexpertSwapV1Router01 {
...
contract FIRE is Context, IERC20, Ownable {
    ...
    IDexpertSwapV1Router01 private _router;
    ...
    function openTrading(uint tokenAmount, address routerAddress) external payable onlyOwner() {
        ...
        _router = IDexpertSwapV1Router01(routerAddress);
        _approve(address(this), address(_router), tokenAmount);
        console.log("_router.factory()",_router.factory());
        IDexpertSwapV1Factory factory=IDexpertSwapV1Factory(_router.factory());
        ...
        (uint reserve0, uint reserve1,) = IDexpertSwapV1Pair(_pair).getReserves();
